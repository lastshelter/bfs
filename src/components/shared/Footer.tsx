...
export default function Footer(): React.JSX.Element {
  return (
    <footer className="bg-[#474747] text-white py-16 px-6 border-t border-slate-600/50 font-sans">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 items-start">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-[13px] font-medium text-slate-200">
              <li>
                <Link href="/loans/additional" className="hover:underline hover:text-white transition-smooth">
                  Additional Funding
                </Link>
              </li>
              <li>
                <Link href="/loans/equipment" className="hover:underline hover:text-white transition-smooth">
                  Equipment Financing
                </Link>
              </li>
              <li>
                <Link href="/loans/sba" className="hover:underline hover:text-white transition-smooth">
                  SBA Loans
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <ul className="space-y-3 text-[13px] font-medium">
                <li>
                  <Link href="/about" className="text-slate-200 hover:underline hover:text-white transition-smooth">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="text-[#0ba5f9] hover:underline transition-smooth">
                    Contact Us
                  </Link>
                </li>
              </ul>
            ...
            <div className="space-y-2">
              <h4 className="text-[13px] font-semibold text-slate-300">Please click here to leave a review</h4>
              <a
            ...
            {/* BBB Accreditation */}
            <div className="space-y-2">
              <h4 className="text-[13px] font-semibold text-slate-300">Accredited By</h4>
          ...
          <div className="space-y-4 text-[13px] text-slate-200 leading-relaxed font-medium">
            <div>
              <p className="text-slate-300 font-bold uppercase text-[11px] tracking-wider mb-0.5">Commercial Finance</p>
            ...
            <div className="pt-2">
              ...
              <p className="text-slate-200">20200 West Dixie Hwy. Suite 902</p>
              <p className="text-slate-200">Aventura, Florida</p>
              <p className="text-slate-200">33180</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-[12px] text-slate-300 leading-relaxed max-w-xs font-medium">
              ...
              <div className="flex gap-2">
                <a
                  ...
                  className="w-8 h-8 bg-white flex items-center justify-center text-slate-800 hover:bg-slate-100 transition-smooth rounded-none"
                  aria-label="Facebook"
                >
