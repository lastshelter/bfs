      ...
      <section className="relative overflow-hidden border-b border-slate-800/80 bg-[#06153b]/40 px-6 py-16 md:py-24">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-slate-350 text-xs md:text-sm max-w-2xl mx-auto leading-relaxed">
            At Biggs Funding Solutions we understand the merchant’s frustrations of completing the work for their clients and then having to wait long periods of time to get paid for their work this can affect the cash flow a business and hinder the businesses p...
          </p>
          <div className="pt-4">
            <Link
              href="/apply"
      ...
      <section className="max-w-4xl w-full mx-auto px-6 py-16 space-y-12">
        ...
        <div className="space-y-6">
          <p className="text-xs md:text-sm text-slate-300 leading-relaxed">
            How to Factor Invoices and get Funded?
          </p>
        ...
        <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 bg-slate-950/40 relative">
          ...
          <ul className="space-y-3">
              ...
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Submit invoices to be factored by uploading them to application or separate email</span>
              </li>
            
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Factoring lines up to 5 million</span>
              </li>
            
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Rates as low as 0.25% a week</span>
              </li>
            
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Approval within 24hrs</span>
              </li>
            
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Get 85% to 95% of money owed and the rest later minus fee and rate</span>
              </li>
