      ...
      <section className="relative overflow-hidden border-b border-slate-800/80 bg-[#06153b]/40 px-6 py-16 md:py-24">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-slate-350 text-xs md:text-sm max-w-2xl mx-auto leading-relaxed">
            Equipment loans and leasing can be good for merchants who cannot afford or do not want to purchase their equipment outright themselves we work with lenders that provide several forms of equipment financing. The average term on an equipment loan or eq...
          </p>
          <div className="pt-4">
            <Link
              href="/apply"
      ...
      <section className="max-w-4xl w-full mx-auto px-6 py-16 space-y-12">
        ...
        <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 bg-slate-950/40 relative">
          ...
          <ul className="space-y-3">
              ...
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                ...
                <span>Equipment Loans and Equipment Leasing</span>
              </li>
        ...
        <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 bg-slate-950/40 relative">
          ...
          <ul className="space-y-3">
              ...
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Application for finance completed</span>
              </li>
              ...
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Purchasing from private party bill of sell needed</span>
              </li>
        ...
        <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 bg-slate-950/40 relative">
          ...
          <ul className="space-y-3">
              ...
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Purchase from private party bill of sell needed</span>
              </li>
              ...
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>2 years of business tax returns and current year P&L and Balance Sheet</span>
              </li>
        ...
        <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 bg-slate-950/40 relative">
          ...
          <ul className="space-y-3">
              ...
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Application for funding</span>
              </li>
