      ...
      <section className="relative overflow-hidden border-b border-slate-800/80 bg-[#06153b]/40 px-6 py-16 md:py-24">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-slate-350 text-xs md:text-sm max-w-2xl mx-auto leading-relaxed">
            If you currently have a business loan of some sort or merchant cash advance, we can help to provide you with more working capital not a problem. We can sometimes get you funded up to 9 positions behind you first position depends on whether the busine...
          </p>
          <div className="pt-4">
            <Link
              href="/apply"
