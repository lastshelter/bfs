    ...
    <div className="flex-1 flex flex-col bg-[#020b24] text-slate-100 min-h-screen">
      ...
      <section className="max-w-4xl w-full mx-auto px-6 py-16 space-y-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-xs md:text-sm text-slate-300 leading-relaxed">
            pYWhsWtKYcAPoqlsQgbQ
          </p>
        
          <p className="text-xs md:text-sm text-slate-300 leading-relaxed">
            BVBRfmNgraoDIxCFrGHgmsR
          </p>
        ...
        <h2 className="font-display text-lg font-bold text-white border-b border-slate-800/60 pb-2 mt-6">
          JTPcnNvnafmkqyrWI
        </h2>
      
        <h2 className="font-display text-lg font-bold text-white border-b border-slate-800/60 pb-2 mt-6">
          gLBSHjbBnruAPQSPNGYm
        </h2>
