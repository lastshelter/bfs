      ...
      <section className="relative overflow-hidden border-b border-slate-800/80 bg-[#06153b]/40 px-6 py-16 md:py-24">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-slate-350 text-xs md:text-sm max-w-2xl mx-auto leading-relaxed">
            We offer a lender program that offers 10-year term loans with monthly payments for merchants that are credit challenged whether credit score is under 600, discharged bankruptcies in the past, tax liens with payment plans just to name a few scenarios....
          </p>
          <div className="pt-4">
            <Link
              href="/apply"
      ...
      <section className="max-w-4xl w-full mx-auto px-6 py-16 space-y-12">
        ...
        <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 bg-slate-950/40 relative">
          ...
          <ul className="space-y-3">
              ...
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Complete last 4 months of the business bank statements</span>
              </li>
            
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Copy business owner’s driver’s license</span>
              </li>
            
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Copy of a voided check from account of business bank. Statements</span>
              </li>
            
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Bank login in completed</span>
              </li>
            
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Funding within 5 hours of submission</span>
              </li>
            
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>Monthly payment debited from merchants account</span>
              </li>
        ...
        <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 bg-slate-950/40 relative">
          ...
          <ul className="space-y-3">
              ...
              <li className="text-xs text-slate-300 flex items-start gap-2.5">
                <span className="text-[#0ba5f9] mt-0.5">•</span>
                <span>This loan only is applicable in 30 states across the U.S. please contact us to see if your business is registered in a qualifying State.</span>
              </li>
